...
export default function TopServicesCard() {
  ...
  // IMPORTANT: Ensure these titles match the 'name' field in the ServiceBookingForm (Book.jsx)
  const services = [
    {
    ...
    {
      title: "Logistics Service", // Changed from "Smart Logistics" to match booking form component logic
  ...
  const handleBookNow = (service) => {
    // ⭐ FIXED: Navigate to "/book" instead of "/service-booking" ⭐
    navigate("/book", { state: { service } });
  };

  return (
    <div className="m bg-[#f5f3e8] py-16 px-4">
              ...
              <div className="px-6 pt-6 pb-4 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-end mb-6">
                    <span className="text-2xl text-[#0d5a3c] font-black self-start">
                      ৳
                    </span>
                    <span className="text-5xl font-bold text-[#0d5a3c] ml-1">
                      {service.price}
                    </span>
