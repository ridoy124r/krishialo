        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="w-[575px] h-[845px] rounded-tr-2xl rounded-br-2xl px-[107px] py-12 flex flex-col justify-center bg-white gap-[30px]">
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <span className="text-red-500 hover:text-red-600 font-medium cursor-pointer">
                Register now
              </span>
            </p>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">Or login with social platforms</span>
              </div>
            </div>
